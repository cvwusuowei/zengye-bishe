package com.example.zengye_springboot.generator;
...
public class CodeGen {
    ...
    private static final String schemaName = "zengye";   // 数据库名称，必填
    ...
    private static final String BaseFilePath = System.getProperty("user.dir") + "/zengye_springboot/src/main/java/com/example/zengye_springboot";
    ...
    static void createEntity(String tableName, String entityName) throws SQLException {
        ...
        StringBuilder entityHeadBuild = StrUtil.builder()
                .append("package com.example.zengye_springboot.entity;\n\n")
    ...
    static void createXml(String entityName) {
        ...
        FileUtil.writeString(format, System.getProperty("user.dir") + "/zengye_springboot/src/main/resources/mapper/" + entityName + ".xml", "UTF-8");
