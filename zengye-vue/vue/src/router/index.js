...
const routes = [
    //前台
  {
    ...
    meta: {title:'曾耶商城', path: '曾耶商城', requireAuth: false},
    children: [
      {path: 'person', name: 'person', meta: {title:'个人信息',requireLogin: true}, component: () => import('../views/Person.vue'),},
      {path: 'topview', name: 'topview', meta: {title:'曾耶商城'}, component: () => import('../views/front/TopView.vue'),},
      ...
      {path: 'news', name: 'news', meta: {title:'新闻资讯'}, component: () => import('@/views/front/news/news.vue'),},
