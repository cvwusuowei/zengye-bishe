  ...
  >
    ...
    <el-submenu index="2">
      ...
      <el-submenu v-if="GoodGroup" index="good">
        <template slot="title">健身器材</template>
        <el-menu-item index="/manage/category" v-if="menuFlags.categoryMenu">健身器材分类管理</el-menu-item>
        <el-menu-item index="/manage/carousel" v-if="menuFlags.carouselMenu">轮播图管理</el-menu-item>
        <el-menu-item index="/manage/good" v-if="menuFlags.goodMenu">健身器材管理</el-menu-item>
